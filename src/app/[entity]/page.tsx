...
export const EntityPage = () => {
  ...
  return (
    <m.div>
      <Card className='absolute xl:relative w-[450px] max-h-full  ml-8 right-0 top-0 mt-1 mb-12 grid grid-rows-[auto_minmax(0,1fr)] min-h-0 h-fit'>
        <CardHeader>
